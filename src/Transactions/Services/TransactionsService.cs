...
namespace Transactions.Services
{
    public interface ITransactionsService
    {
        ...
        Task<dynamic> GetTransactionReport(TransactionFilter filter, QueryOptions query);
    }
    ...
    public class TransactionsService : ITransactionsService
    {
        ...
        public async Task<dynamic> GetTransactionReport(TransactionFilter filter, QueryOptions query)
        {
